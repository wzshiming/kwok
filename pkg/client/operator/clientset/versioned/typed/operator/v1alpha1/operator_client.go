...
import (
	...
	"sigs.k8s.io/kwok/pkg/client/operator/clientset/versioned/scheme"
)
...
func (c *OperatorV1alpha1Client) Kwoks(namespace string) KwokInterface {
	return newKwoks(c, namespace)
}
