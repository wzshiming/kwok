...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ClusterMetric)(nil), (*v1alpha1.ClusterMetric)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_internalversion_ClusterMetric_To_v1alpha1_ClusterMetric(a.(*ClusterMetric), b.(*v1alpha1.ClusterMetric), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.ClusterMetric)(nil), (*ClusterMetric)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ClusterMetric_To_internalversion_ClusterMetric(a.(*v1alpha1.ClusterMetric), b.(*ClusterMetric), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*ClusterMetricSpec)(nil), (*v1alpha1.ClusterMetricSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_internalversion_ClusterMetricSpec_To_v1alpha1_ClusterMetricSpec(a.(*ClusterMetricSpec), b.(*v1alpha1.ClusterMetricSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.ClusterMetricSpec)(nil), (*ClusterMetricSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ClusterMetricSpec_To_internalversion_ClusterMetricSpec(a.(*v1alpha1.ClusterMetricSpec), b.(*ClusterMetricSpec), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ObjectSelectorNames)(nil), (*v1alpha1.ObjectSelectorNames)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_internalversion_ObjectSelectorNames_To_v1alpha1_ObjectSelectorNames(a.(*ObjectSelectorNames), b.(*v1alpha1.ObjectSelectorNames), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.ObjectSelectorNames)(nil), (*ObjectSelectorNames)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ObjectSelectorNames_To_internalversion_ObjectSelectorNames(a.(*v1alpha1.ObjectSelectorNames), b.(*ObjectSelectorNames), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_internalversion_ClusterMetric_To_v1alpha1_ClusterMetric(in *ClusterMetric, out *v1alpha1.ClusterMetric, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_internalversion_ClusterMetricSpec_To_v1alpha1_ClusterMetricSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}

// Convert_internalversion_ClusterMetric_To_v1alpha1_ClusterMetric is an autogenerated conversion function.
func Convert_internalversion_ClusterMetric_To_v1alpha1_ClusterMetric(in *ClusterMetric, out *v1alpha1.ClusterMetric, s conversion.Scope) error {
	return autoConvert_internalversion_ClusterMetric_To_v1alpha1_ClusterMetric(in, out, s)
}

func autoConvert_v1alpha1_ClusterMetric_To_internalversion_ClusterMetric(in *v1alpha1.ClusterMetric, out *ClusterMetric, s conversion.Scope) error {
	// INFO: in.TypeMeta opted out of conversion generation
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_ClusterMetricSpec_To_internalversion_ClusterMetricSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_ClusterMetric_To_internalversion_ClusterMetric is an autogenerated conversion function.
func Convert_v1alpha1_ClusterMetric_To_internalversion_ClusterMetric(in *v1alpha1.ClusterMetric, out *ClusterMetric, s conversion.Scope) error {
	return autoConvert_v1alpha1_ClusterMetric_To_internalversion_ClusterMetric(in, out, s)
}

func autoConvert_internalversion_ClusterMetricSpec_To_v1alpha1_ClusterMetricSpec(in *ClusterMetricSpec, out *v1alpha1.ClusterMetricSpec, s conversion.Scope) error {
	out.Selector = (*v1alpha1.ObjectSelectorNames)(unsafe.Pointer(in.Selector))
	out.Path = in.Path
	out.Metrics = *(*[]v1alpha1.MetricConfig)(unsafe.Pointer(&in.Metrics))
	return nil
}

// Convert_internalversion_ClusterMetricSpec_To_v1alpha1_ClusterMetricSpec is an autogenerated conversion function.
func Convert_internalversion_ClusterMetricSpec_To_v1alpha1_ClusterMetricSpec(in *ClusterMetricSpec, out *v1alpha1.ClusterMetricSpec, s conversion.Scope) error {
	return autoConvert_internalversion_ClusterMetricSpec_To_v1alpha1_ClusterMetricSpec(in, out, s)
}

func autoConvert_v1alpha1_ClusterMetricSpec_To_internalversion_ClusterMetricSpec(in *v1alpha1.ClusterMetricSpec, out *ClusterMetricSpec, s conversion.Scope) error {
	out.Selector = (*ObjectSelectorNames)(unsafe.Pointer(in.Selector))
	out.Path = in.Path
	out.Metrics = *(*[]MetricConfig)(unsafe.Pointer(&in.Metrics))
	return nil
}

// Convert_v1alpha1_ClusterMetricSpec_To_internalversion_ClusterMetricSpec is an autogenerated conversion function.
func Convert_v1alpha1_ClusterMetricSpec_To_internalversion_ClusterMetricSpec(in *v1alpha1.ClusterMetricSpec, out *ClusterMetricSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_ClusterMetricSpec_To_internalversion_ClusterMetricSpec(in, out, s)
}
...
func autoConvert_internalversion_ObjectSelectorNames_To_v1alpha1_ObjectSelectorNames(in *ObjectSelectorNames, out *v1alpha1.ObjectSelectorNames, s conversion.Scope) error {
	out.MatchNames = *(*[]string)(unsafe.Pointer(&in.MatchNames))
	return nil
}

// Convert_internalversion_ObjectSelectorNames_To_v1alpha1_ObjectSelectorNames is an autogenerated conversion function.
func Convert_internalversion_ObjectSelectorNames_To_v1alpha1_ObjectSelectorNames(in *ObjectSelectorNames, out *v1alpha1.ObjectSelectorNames, s conversion.Scope) error {
	return autoConvert_internalversion_ObjectSelectorNames_To_v1alpha1_ObjectSelectorNames(in, out, s)
}

func autoConvert_v1alpha1_ObjectSelectorNames_To_internalversion_ObjectSelectorNames(in *v1alpha1.ObjectSelectorNames, out *ObjectSelectorNames, s conversion.Scope) error {
	out.MatchNames = *(*[]string)(unsafe.Pointer(&in.MatchNames))
	return nil
}

// Convert_v1alpha1_ObjectSelectorNames_To_internalversion_ObjectSelectorNames is an autogenerated conversion function.
func Convert_v1alpha1_ObjectSelectorNames_To_internalversion_ObjectSelectorNames(in *v1alpha1.ObjectSelectorNames, out *ObjectSelectorNames, s conversion.Scope) error {
	return autoConvert_v1alpha1_ObjectSelectorNames_To_internalversion_ObjectSelectorNames(in, out, s)
}
